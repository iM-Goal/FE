            ...
            <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.header}>
                    <View>
                        ...
                        <Text style={styles.subGreeting}>오늘도 목표를 향해 가는 중이에요</Text>
                    </View>
                ...
                >
                    <View style={styles.textContainer}>
                        <Text style={styles.emptyCardTitle}>아직 등록된 목표가 없어요 🎯</Text>
                        <Text style={styles.emptyCardSub}>iM AgentiX와 함께 새 저축 목표를 세워볼까요?</Text>
                    </View>
                ...
                <View style={styles.walletSection}>
                    ...
                    <View style={styles.walletCard}>
                        ...
                        <View style={styles.walletItem}>
                            ...
                            <Text style={styles.walletAmount}>{dashboardData.wallet.living}</Text>
                        </View>
                        ...
                        <View style={styles.walletItem}>
                            ...
                            <Text style={styles.walletAmount}>{dashboardData.wallet.free}</Text>
                        </View>
                        <View style={styles.divider} />
                        ...
                        <View style={styles.walletItem}>
                            ...
                            <Text style={styles.walletAmount}>{dashboardData.wallet.goal}</Text>
                        </View>

                        {/* 토큰 조정하기 알약 버튼 */}
                        <TouchableOpacity style={styles.adjustButton}>
                            <Ionicons name="options-outline" size={18} color="#475569" style={{ marginRight: 6 }} />
